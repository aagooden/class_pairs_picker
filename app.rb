...
#If you remember from today, we had to .join(',') each element in the array so the formatting of the array was the same.
...
# The next steps (That we discussed today) would be as follows:
